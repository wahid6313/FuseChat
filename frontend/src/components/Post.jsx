...
function Post({ post }) {
  ...
  const commentHandler = async () => {
    try {
      const res = await axios.post(
        `https://fusechat.onrender.com/api/v1/post/${post._id}/comment`,
        { text },
        {
          headers: {
  ...
  const likeOrDislikeHandler = async () => {
    try {
      ...
      const res = await axios.get(
        `https://fusechat.onrender.com/api/v1/post/${post._id}/${action}`,
        { withCredentials: true }
      );
      if (res.data.success) {
  ...
  const deletePostHandler = async () => {
    try {
      const res = await axios.delete(
        `https://fusechat.onrender.com/api/v1/post/delete/${post?._id}`,
        { withCredentials: true }
      );
      if (res.data.success) {
  ...
  const bookmarkHandler = async () => {
    try {
      const res = await axios.get(
        `https://fusechat.onrender.com/api/v1/post/${post?._id}/bookmark`,
        { withCredentials: true }
      );
      if (res.data.success) {
        toast.success(res.data.message);
